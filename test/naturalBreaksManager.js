...
describe('naturalBreaksManager', function () {
  ...
  it('should not be running with default settings', () => {
  ...
  it('should reset when reset()', () => {
    naturalBreaksManager.reset()
    naturalBreaksManager.isOnNaturalBreak.should.be.equal(false)
    naturalBreaksManager.usingNaturalBreaks.should.be.equal(true)
  })

  it('should reset when on resetIdleTime', () => {
    naturalBreaksManager.emit('resetIdleTime')
    naturalBreaksManager.isOnNaturalBreak.should.be.equal(false)
    naturalBreaksManager.usingNaturalBreaks.should.be.equal(true)
  })
